...
const StoryModel = ({setShowModal,fetchStories}) => {
  ...
  "#F7971E"  // orange
    ...
    const MAX_VIDEO_DURATION = 60 //max video story length
    const MAX_VIDEO_SIZE = 50 // max video size
        ...
        <div className='w-full max-w-md'>
            ...
            <div className='rounded-lg h-96 flex items-center justify-center relative' style={{backgroundColor : background}}>
                ...
                <div className='flex gap-2 mt-4'>
                    <button 
                    onClick={()=>{setMode('text');setMedia(null);setPreviewUrl(null)}} className={`flex-1 flex items-center cursor-pointer justify-center gap-2 p-2 rounded 

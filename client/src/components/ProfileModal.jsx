        ...
        <div className='max-w-2xl sm:py-6 mx-auto'>
            <div className='bg-white rounded-lg shadow p-6'>
                ...
                <form className='space-y-4' onSubmit={handleSaveProfile}>
                    {/* Profile Picture */}
                    <p className='block text-sm font-medium text-gray-700 mb-1'>Profile Picture</p>
                    <input hidden type="file" accept="image/*" id="profile_picture" className='w-full p-3 border border-gray-200 rounded-lg'
                    onChange={(e)=>setEditForm({...e,profile_picture:e.target.files[0]})} />
                    ...
                    {/* Cover Photo */}
                    <div className='flex flex-col items-start gap-3'>
                        <p className='block text-sm font-medium text-gray-700 mb-1'>Cover Photo</p>
                        <input hidden type="file" accept="image/*" id="cover_photo" className='w-full p-3 border border-gray-200 rounded-lg'
                        onChange={(e)=>setEditForm({...e,cover_photo:e.target.files[0]})} />
                        <label htmlFor="cover_photo" className='block text-sm font-medium text-gray-700 mb-1'>
                            <div className='group/cover relative'>
                                ...
                                className='w-80 h-40 rounded-lg bg-gradient-to-r form-indigo-200 to-pink-200 object-cover mt-2' />
                    ...
                    <div>
                        ...
                        <input type='text' className='w-full p-3 border border-gray-200 rounded-lg' placeholder='Please enter your fullname'
                        onChange={(e)=>setEditForm({...e,username:e.target.value})} value={editForm.username}/>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea type='text' className='w-full p-3 border border-gray-200 rounded-lg' placeholder='Please enter your bio'
                        onChange={(e)=>setEditForm({...e,bio:e.target.value})} value={editForm.bio}/>
                    </div>
                    ...
                    <div>
                        ...
                        onChange={(e)=>setEditForm({...e,location:e.target.value})} value={editForm.location}/>
                    </div>
